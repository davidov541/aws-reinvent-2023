...
variable "create_db_airflow" {
  description = "Creates Airflow Database, enable it beforehand for faster setup"
  type        = bool
  default     = true
}
...
variable "enable_karpenter" {
  description = "Enable Karpenter and Spot Interruption Handling with Karenter"
  type        = bool
  default     = true
}
